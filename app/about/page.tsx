      ...
      <section className="mx-auto container px-4 md:px-8 py-20 pt-24">
        <div className="mb-8 flex flex-wrap justify-between md:mb-16">
          <div className="mb-6 flex w-full flex-col justify-center sm:mb-12 lg:mb-0 lg:w-1/3 lg:pb-24 lg:pt-48">
            <h1 className="mb-4 text-4xl font-bold text-slate-50 sm:text-5xl md:mb-8 md:text-6xl">About NGL Agency.</h1>
              ...
              <div>
                ...
                <div className="flex justify-center">
                  <div className="flex gap-4">
                    <a href="#" target="_blank" className="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-500">
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          <div className="flex flex-col overflow-hidden rounded-lg bg-gray-900 sm:flex-row md:h-80">
            ...
            <div className="flex w-full flex-col p-4 sm:w-1/2 sm:p-8 lg:w-3/5">
              ...
              <p className="mb-8 max-w-md text-gray-500">This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text.</p>
