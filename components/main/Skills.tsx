                ...
                <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-x-6 lg:gap-x-14 gap-y-8 md:items-end">
                    <div className="space-y-4 md:space-y-6 md:col-span-2 lg:col-span-1 w-full max-w-3xl lg:max-w-none mx-auto lg:mx-0 text-center lg:text-left">
                        <h1 className="font-display font-semibold text-2xl md:text-3xl text-gray-900 dark:text-white">
                            Web design Agency based in Nowhere!
                        </h1>
                        ...
                        <div className="flex justify-center lg:justify-start">
                            <Link href="#" className="px-6 h-11 flex items-center rounded-lg bg-gray-900 dark:bg-white text-white dark:text-gray-900 text-sm transition ease-linear hover:bg-gray-900">Hire us</Link>
                        </div>
                    ...
                    <div className="flex justify-center">
                        <div className="max-w-full relative">
                            ...
                            <Image src="/6.png" width={1240} height={1376} alt="Developer with laptop smile" className="relative w-full h-auto max-h-96 lg:max-h-[26rem]" />
                        </div>
                    </div>
                    <div className="space-y-3 lg:space-y-6">
                        <div className="flex items-start relative gap-x-4 p-2 md:p-3 lg:p-4 bg-gradient-to-br from-purple-600 to-pink-500 dark:from-indigo-600 dark:to-blue-500 border border-gray-100/80 dark:border-gray-900/80 rounded-lg">
                            <span className="min-w-max text-gray-600 p-2 md:p-3 rounded-lg dark:text-gray-200">
                            ...
                            <div>
                                <span className="font-semibold text-gray-800  dark:text-gray-200 text-lg">Modern AI Skills</span>
                                <p className="text-gray-700 dark:text-gray-300">
                                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                </p>
                            </div>
                            <div className="absolute inset-0 bg-gradient-to-br from-purple-600 to-pink-500 dark:from-indigo-600 dark:to-blue-500 opacity-50 filter blur-3xl" />
                        </div>
                        <div className="flex items-start relative gap-x-4 p-2 md:p-3 lg:p-4  bg-gradient-to-br from-purple-600 to-pink-500 dark:from-indigo-600 dark:to-blue-500 border border-gray-100/80 dark:border-gray-900/80 rounded-lg">
                            <span className="min-w-max text-gray-600 p-2 md:p-3 rounded-lg dark:text-gray-200">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" width={24} height={24} className="w-6 h-6">
                            ...
                            <div>
                                <span className="font-semibold text-gray-800  dark:text-gray-200 text-lg">Latest & Scalable Technology</span>
                                <p className="text-gray-700 dark:text-gray-300">
                                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                </p>
                            </div>
                        ...
                        <div className="flex items-start relative gap-x-4 p-2 md:p-3 lg:p-4  bg-gradient-to-br from-purple-600 to-pink-500 dark:from-indigo-600 dark:to-blue-500 border border-gray-100/80 dark:border-gray-900/80 rounded-lg">
                            ...
                            <div>
                                <span className="font-semibold text-gray-800 dark:text-gray-200 text-lg">50+ Team members</span>
                                <p className="text-gray-700 dark:text-gray-300">
                                    Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                </p>
                            </div>
